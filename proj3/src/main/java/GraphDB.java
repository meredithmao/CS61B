...
public class GraphDB {
    ...
    public class Node {
        ...
        public void connectNodes(long identity) {
            adjacentNodes.add(identity);
        }
    ...
    long closest(double lon, double lat) {
        ...
        Node closest = null;
        for (Node v : nodeMap.values()) {
            double currDistance = distance(v.lon, v.lat, lon, lat);
