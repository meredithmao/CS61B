...
public class Tileset {
    public static final TETile PLAYER(boolean right) {
        if (right) {
            return new TETile('S', Color.black, Color.black, "player", "playerright.png");
        } else {
            return new TETile('S', Color.black, Color.black, "player", "playerleft.png");
        }
    }
    ...
    public static final TETile WATER = new TETile('≈', Color.blue, Color.black, "water", "water.gif");
