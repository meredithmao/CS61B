...
//            System.out.println("Tag with k=" + k + ", v=" + v + ".");
            ...
            g.nodeMap.get(tempId).setName(name);
...
//            System.out.println("Finishing a way...");
            if (validWay) {
                for (int i = 0; i < possibleConnections.size() - 1; i++) {
                    long nodeID = possibleConnections.get(i);
                    long nodeID2 = possibleConnections.get(i + 1);
                    g.nodeMap.get(nodeID).connectNodes(nodeID2);
                    g.nodeMap.get(nodeID2).connectNodes(nodeID);
                }
